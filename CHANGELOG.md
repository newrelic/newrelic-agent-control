...
- On-host: fixed a spurious `Error reading the log directory/files: No such file or directory` message printed to stderr the first time a sub-agent's log directory is created.
