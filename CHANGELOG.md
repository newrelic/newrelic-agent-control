...
- Agent type: reject `.` and `:` (and other special characters) in variable names and `string_map` keys, to avoid ambiguity with the templating and namespace separators.
