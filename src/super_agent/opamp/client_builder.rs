...
use crate::super_agent::opamp::remote_config_updater::SuperAgentRemoteConfigUpdater;
...
impl OpAMPClientBuilder for SuperAgentOpAMPHttpBuilder {
    type Client =
        StartedHttpClient<AgentCallbacks<SuperAgentRemoteConfigUpdater>, HttpClientReqwest>;
    fn build_and_start(
        &self,
        ...
        let remote_config_updater = SuperAgentRemoteConfigUpdater::new(ctx);
