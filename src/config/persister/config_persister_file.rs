...
mod test {
    ...
    fn test_persist_multiple_single_files() {
        ...
        // Expectations
        directory_manager.should_delete(generated_conf_path.as_path());
        ...
        assert_eq!(true, persister.persist(&agent_id, &agent_type).is_ok());
    }
    ...
    fn test_error_deleting_directory() {
        ...
        let result = persister.persist(&agent_id, &agent_type);
    ...
    fn test_error_creating_agent_directory() {
        ...
        let persist_result = persister.persist(&agent_id, &agent_type);
    ...
    fn test_persister_with_custom_data_dir() {
        ...
        let persister = ConfigurationPersisterFile::new(custom_data_dir.to_string());
