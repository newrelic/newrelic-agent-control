...
cargo zigbuild --target "${TARGET_TUPLE}" --profile "release-debug" --package "${PKG}" --bin "${BIN}" --features dhat-heap
...
cp "./target/${TARGET_TUPLE}/release-debug/${BIN}" "./bin/${TRIMMED_BIN}-${ARCH}"
