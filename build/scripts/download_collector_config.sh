...
URL="https://raw.githubusercontent.com/newrelic/nrdot-collector-releases/refs/tags/${NR_OTEL_COLLECTOR_VERSION}/distributions/nrdot-collector/${DEFAULT_CONFIG_FILENAME}"
