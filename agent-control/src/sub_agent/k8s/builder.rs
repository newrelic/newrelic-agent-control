...
use crate::sub_agent::supervisor::SupervisorBuilder as NewSupervisorBuilder;
...
impl NewSupervisorBuilder for SupervisorBuilderK8s {
...
pub mod tests {
    ...
    fn test_supervisor_build_ok() {
        ...
        supervisor::builder::SupervisorBuilder::build_supervisor(
            &supervisor_builder,
            effective_agent,
        )
        .unwrap();
    ...
    fn test_supervisor_build_fails_for_invalid_k8s_object_kind() {
        ...
        let result = supervisor::builder::SupervisorBuilder::build_supervisor(
            &supervisor_builder,
            effective_agent,
        );
        assert_matches!(
