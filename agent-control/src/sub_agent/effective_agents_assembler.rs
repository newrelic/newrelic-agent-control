    ...
    Y: Renderer,
{
    pub fn new(
        ...
        LocalEffectiveAgentsAssembler {
            ...
            secrets_providers,
            auto_generated_dir: Path::new(AGENT_CONTROL_DATA_DIR).join(GENERATED_FOLDER_NAME),
        }
    }

    pub fn with_autogenerated_dir(self, path: impl AsRef<Path>) -> Self {
        Self {
            auto_generated_dir: path.as_ref().join(GENERATED_FOLDER_NAME),
            ..self
        }
    }
}
