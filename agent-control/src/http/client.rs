...
impl HttpClient {
    ...
    pub fn new(http_config: HttpConfig) -> Result<Self, HttpBuildError> {
        let mut builder =
            http_client_builder_with_timeout(http_config.timeout, http_config.conn_timeout);
    ...
    pub fn new_client_builder_with_timeout(
        timeout: Duration,
...
pub fn http_client_builder_with_timeout(
    timeout: Duration,
    conn_timeout: Duration,
) -> ClientBuilder {
    Client::builder()
