    ...
    W: FileWriter,
{
    fn persist_agent_config(
        ...
        self.directory_manager
            .create(Path::new(&self.generated_conf_path))?;
...
mod tests {
    ...
    fn test_persist_multiple_single_files() {
        ...
        directory_manager.should_create(generated_conf_path.as_path());
        directory_manager.should_create(agent_files_path.as_path());
    ...
    fn test_persist_multiple_single_map_files() {
        ...
        directory_manager.should_create(config_kafka_path.as_path());
        ...
        // We need to mock create because path will never exist on the test
        directory_manager.should_create(config_mysql_path.as_path());
        ...
        // We need to mock create because path will never exist on the test
        directory_manager.should_create(config_redis_path.as_path());
    ...
    fn test_persist_multiple_multiple_map_files() {
        ...
        // We need to mock create because path will never exist on the test
        directory_manager.should_create(config_logging_file_path.as_path());
        ...
        // We need to mock create because path will never exist on the test
        directory_manager.should_create(config_logging_systemctl_path.as_path());
    ...
    fn test_writing_filemap_type_should_stop_processing_the_rest() {
        ...
        // We need to mock create because path will never exist on the test
        directory_manager.should_create(integrations_path.as_path());
        let mut integrations_path = agent_files_path.clone();
        integrations_path.push("integrations.d");
        // We need to mock create because path will never exist on the test
        directory_manager.should_create(integrations_path.as_path());
