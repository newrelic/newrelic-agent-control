...
1. Create a fil in `dynamic-agent-type.yaml` file with the agent type definition
...
2. Copy the agent type definition to `/etc/newrelic-agent-control/dynamic-agent-types`
