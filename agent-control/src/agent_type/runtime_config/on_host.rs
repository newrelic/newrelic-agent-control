...
use crate::agent_type::definition::{VariableValues, include_packages_variables};
...
"#;
        ...
        vars.insert(
            ...
            VariableValue::String("/tmp/auto/filesystem".to_string()),
        );
...
"#;
        ...
        vars.insert(
            VariableName::new(Namespace::SubAgent, AgentAttributes::NR_SUB_REMOTE_DIR),
            VariableValue::String("/tmp/auto".to_string()),
        );
        vars.insert(
            VariableName::new(Namespace::SubAgent, AgentAttributes::NR_SUB_AGENT_ID),
            VariableValue::String("agent-id".to_string()),
...
"#;
    ...
    fn test_replacer() {
        ...
        let normalized_values = HashMap::from([
            ...
            (
                ...
                VariableValue::String("trace".to_string()),
            ),
            (
                VariableName::new(Namespace::Variable, "backoff.type"),
                VariableValue::String("exponential".to_string()),
            ),
            (
                VariableName::new(Namespace::Variable, "backoff.delay"),
                VariableValue::String("10s".to_string()),
            ),
            (
            ...
            (
                ...
                VariableValue::String("300s".to_string()),
            ),
        ]);
    ...
    fn test_replacer_two_same() {
        ...
        let normalized_values = HashMap::from([
            ...
            (
                VariableName::new(Namespace::Variable, "backoff.type"),
                VariableValue::String("linear".to_string()),
            ),
            (
                VariableName::new(Namespace::Variable, "backoff.delay"),
                VariableValue::String("10s".to_string()),
    ...
    fn test_template_executable() {
        let variables = VariableValues::from([
            (
                ...
                VariableValue::String("/usr/bin/myapp".to_string()),
            ),
            (
                VariableName::new(Namespace::Variable, "args"),
                VariableValue::String("--my_arg".to_string()),
            ),
            (
                VariableName::new(Namespace::Variable, "env.MYAPP_PORT"),
                VariableValue::String("8080".to_string()),
            ),
            (
                VariableName::new(Namespace::Variable, "backoff.type"),
                VariableValue::String("linear".to_string()),
