...
use newrelic_super_agent::opamp::instance_id::getter::{IDGetter, InstanceIDGetterInMemory};
use newrelic_super_agent::opamp::instance_id::InstanceIDGetter;
use newrelic_super_agent::super_agent::config::AgentID;
use std::sync::Arc;

pub fn get_instance_id(namespace: &str, agent_id: &AgentID) -> InstanceIDGetter {
