...
use newrelic_super_agent::opamp::instance_id::getter::{InstanceIDGetter, UUIDInstanceIDGetter};
...
pub fn get_instance_id(namespace: &str, agent_id: &AgentID) -> InstanceID {
    ...
    let instance_id_getter = UUIDInstanceIDGetter::new_k8s_instance_id_getter(
