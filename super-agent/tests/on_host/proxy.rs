...
use crate::on_host::tools::config::create_super_agent_config_with_proxy;
...
#[test]
fn proxy_onhost_opamp_super_agent_local_effective_config() {
    ...
    create_super_agent_config_with_proxy(
